...
class OthelloGame(np.ndarray):
    ...
    def __init__(self, n):
        self.n=n # 棋盤大小
        self.current_player=OthelloGame.BLACK # BLACK = 1, WHITE = -1 黑的先手
        # 初始化棋盤
    ...
    def move(self, position): # 合法則翻棋，current_player改成另一位
    ...
    #雙方皆無合法步可走，則遊戲結束
    def isEndGame(self): # 未結束:None, Black win:1, White win:-1, 平手:0 
